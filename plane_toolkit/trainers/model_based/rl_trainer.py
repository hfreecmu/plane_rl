...
from plane_toolkit.trainers.model_based.mb_agent import MBAgent
from plane_toolkit.trainers.model_based import pytorch_util as ptu
from plane_toolkit.trainers.model_based import utils
from plane_toolkit.trainers.model_based.logger import Logger
...
class RL_Trainer(object):
    ...
    def __init__(self, params, info_dict):
        ...
        self.env = gym.make("plane-v0", info_dict=info_dict)
        self.env.seed(seed)
