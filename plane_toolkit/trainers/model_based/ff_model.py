...
from plane_toolkit.trainers.model_based.base_model import BaseModel
from plane_toolkit.trainers.model_based.utils import normalize, unnormalize
from plane_toolkit.trainers.model_based import pytorch_util as ptu
...
class FFModel(nn.Module, BaseModel):
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        _, delta_pred_normalized = self(observations, actions, obs_mean, obs_std, acs_mean, acs_std, delta_mean, delta_std)
